                ...
                <div class="row">
                     ...
                     <article class="post" itemscope="" itemtype="https://schema.org/BlogPosting">
                         <header>
                             ...
                             <div class="author">
                                 Por <span itemprop="author" itemscope="" itemtype="https://schema.org/Person"><span itemprop="name">{{ $author->name }}</span></span>
                             </div>
                             <hr>
                         ...
                         <div itemprop="articleBody">
                             <p><img src="{{ URL::asset('./image/' . $article->image) }}" alt="Article image" width="750" class="img-responsive"></p>
